...
{hook name="profiles:account_info"}
    <div class="ty-control-group">
        ...
        <label for="referenceemail" class="ty-control-group__title cm-required cm-email cm-trim">{("Reference email")}</label>
        <input type="text" id="Reference email" name="user_data[referenceemail]" size="32" maxlength="128" value="{$user_data.referenceemail}" class="ty-input-text cm-focus" />
    </div>
