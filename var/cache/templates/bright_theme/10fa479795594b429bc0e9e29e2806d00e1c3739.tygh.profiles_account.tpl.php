<?php /* Smarty version Smarty-3.1.21, created on 2021-06-14 22:58:32
         compiled from "C:\xampp\htdocs\cscart\design\themes\responsive\templates\views\profiles\components\profiles_account.tpl" */ ?>
<?php /*%%SmartyHeaderCode:129497807960c7b4e86583f8-87147012%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '129497807960c7b4e86583f8-87147012',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60c7b4e86782a8_15139261',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60c7b4e86782a8_15139261')) {function content_60c7b4e86782a8_15139261($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\block.hook.php';
...
" class="ty-input-text cm-focus" />
        <label for="referenceemail" class="ty-control-group__title cm-required cm-email cm-trim"><?php echo htmlspecialchars(("Reference email"), ENT_QUOTES, 'UTF-8');?>
</label>
        <input type="text" id="Reference email" name="user_data[referenceemail]" size="32" maxlength="128" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['referenceemail'], ENT_QUOTES, 'UTF-8');?>
" class="ty-input-text cm-focus" />
    </div>
